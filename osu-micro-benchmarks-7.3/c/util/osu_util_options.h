...
#define OMBOP_LONG_OPTIONS_ALL                                                 \
    {                                                                          \
        {"help", no_argument, 0, 'h'}, {"version", no_argument, 0, 'v'},       \
            ...
            {"dump-lat", required_argument, 0, 'X'},                           \
        {                                                                      \
...
#define OMBOP__COLLECTIVE__ALL_GATHER        OMBOP__COLLECTIVE__ALLTOALL "X:"
...
#define OMBOP__COLLECTIVE__BCAST              "+:hvfm:i:x:M:a:cu:G:D:P:T:IzX:"
    ...
    {                                                                          \
        {'h', "print this help"}, {'v', "print version info"},                 \
            ...
            {'w', "WIN_OPTION - Supports MPI>=3. Can be any of the follows:"   \
                  ...
                  "MPI Window object"},                                        \
            {'M',                                                              \
             "SIZE - set per process maximum memory consumption to SIZE bytes" \
             "~~(default 536870912)"},                                         \
            ...
            {'X', "[dump-directory-path] dump per-rank/iteration measurements"},  \
        {                                                                      \
